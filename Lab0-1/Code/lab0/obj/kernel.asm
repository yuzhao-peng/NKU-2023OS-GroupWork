...
int kern_init(void) {
    ...
    80200034:	4e850513          	addi	a0,a0,1256 # 80200518 <memset+0x4a>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802000d6:	5de78793          	addi	a5,a5,1502 # 802006b0 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020012a:	3faa0a13          	addi	s4,s4,1018 # 80200520 <memset+0x52>
    ...
    80200136:	546c0c13          	addi	s8,s8,1350 # 80200678 <error_string>
    ...
    80200224:	54060613          	addi	a2,a2,1344 # 80200760 <error_string+0xe8>
    ...
    802003b8:	39c60613          	addi	a2,a2,924 # 80200750 <error_string+0xd8>
    ...
    802003ca:	38260613          	addi	a2,a2,898 # 80200748 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    802003ce:	00000417          	auipc	s0,0x0
    802003d2:	37b40413          	addi	s0,s0,891 # 80200749 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    8020045e:	2ef40413          	addi	s0,s0,751 # 80200749 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
