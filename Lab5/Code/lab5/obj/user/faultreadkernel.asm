...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	55c50513          	addi	a0,a0,1372 # 800590 <main+0x32>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	55c50513          	addi	a0,a0,1372 # 8005b0 <main+0x52>
...
exit(int error_code) {
  ...
  80012a:	49250513          	addi	a0,a0,1170 # 8005b8 <main+0x5a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	67278793          	addi	a5,a5,1650 # 8007f0 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d6:	3faa0a13          	addi	s4,s4,1018 # 8005cc <main+0x6e>
  ...
  8001e2:	54ac0c13          	addi	s8,s8,1354 # 800728 <error_string>
  ...
  8002d0:	61460613          	addi	a2,a2,1556 # 8008e0 <error_string+0x1b8>
  ...
  800464:	47060613          	addi	a2,a2,1136 # 8008d0 <error_string+0x1a8>
  ...
  800476:	45660613          	addi	a2,a2,1110 # 8008c8 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80047a:	00000417          	auipc	s0,0x0
  80047e:	44f40413          	addi	s0,s0,1103 # 8008c9 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  80050a:	3c340413          	addi	s0,s0,963 # 8008c9 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800570:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800572:	b2fff0ef          	jal	ra,8000a0 <cprintf>
    panic("FAIL: T.T\n");
