...
00000000008000c4 <sys_pgdir>:
}

int
sys_pgdir(void) {
    return syscall(SYS_pgdir);
  8000c4:	457d                	li	a0,31
...
exit(int error_code) {
  ...
  8000d6:	46e50513          	addi	a0,a0,1134 # 800540 <main+0x2e>
...
getpid(void) {
    return sys_getpid();
  8000e0:	fd7ff06f          	j	8000b6 <sys_getpid>

00000000008000e4 <print_pgdir>:
}
...
print_pgdir(void) {
    sys_pgdir();
  8000e4:	fe1ff06f          	j	8000c4 <sys_pgdir>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800136:	64678793          	addi	a5,a5,1606 # 800778 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018a:	3cea0a13          	addi	s4,s4,974 # 800554 <main+0x42>
  ...
  800196:	51ec0c13          	addi	s8,s8,1310 # 8006b0 <error_string>
  ...
  800284:	5e860613          	addi	a2,a2,1512 # 800868 <error_string+0x1b8>
  ...
  800418:	44460613          	addi	a2,a2,1092 # 800858 <error_string+0x1a8>
  ...
  80042a:	42a60613          	addi	a2,a2,1066 # 800850 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80042e:	00000417          	auipc	s0,0x0
  800432:	42340413          	addi	s0,s0,1059 # 800851 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  8004be:	39740413          	addi	s0,s0,919 # 800851 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800516:	bcbff0ef          	jal	ra,8000e0 <getpid>
