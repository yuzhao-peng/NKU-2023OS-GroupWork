...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	56450513          	addi	a0,a0,1380 # 800598 <main+0x3a>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	56450513          	addi	a0,a0,1380 # 8005b8 <main+0x5a>
...
exit(int error_code) {
  ...
  80012a:	49a50513          	addi	a0,a0,1178 # 8005c0 <main+0x62>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	67a78793          	addi	a5,a5,1658 # 8007f8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d6:	402a0a13          	addi	s4,s4,1026 # 8005d4 <main+0x76>
  ...
  8001e2:	552c0c13          	addi	s8,s8,1362 # 800730 <error_string>
  ...
  8002d0:	61c60613          	addi	a2,a2,1564 # 8008e8 <error_string+0x1b8>
  ...
  800464:	47860613          	addi	a2,a2,1144 # 8008d8 <error_string+0x1a8>
  ...
  800476:	45e60613          	addi	a2,a2,1118 # 8008d0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80047a:	00000417          	auipc	s0,0x0
  80047e:	45740413          	addi	s0,s0,1111 # 8008d1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  80050a:	3cb40413          	addi	s0,s0,971 # 8008d1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
    cprintf("value is %d.\n", 1 / zero);
  80055e:	00001797          	auipc	a5,0x1
  800562:	aa278793          	addi	a5,a5,-1374 # 801000 <zero>
  800566:	439c                	lw	a5,0(a5)
  800568:	4585                	li	a1,1
main(void) {
  80056a:	1141                	addi	sp,sp,-16
    cprintf("value is %d.\n", 1 / zero);
  80056c:	02f5c5bb          	divw	a1,a1,a5
  800570:	00000517          	auipc	a0,0x0
  800574:	38050513          	addi	a0,a0,896 # 8008f0 <error_string+0x1c0>
main(void) {
  800578:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  80057a:	b27ff0ef          	jal	ra,8000a0 <cprintf>
    panic("FAIL: T.T\n");
  80057e:	00000617          	auipc	a2,0x0
  800582:	38260613          	addi	a2,a2,898 # 800900 <error_string+0x1d0>
  800586:	45a5                	li	a1,9
  800588:	00000517          	auipc	a0,0x0
  80058c:	38850513          	addi	a0,a0,904 # 800910 <error_string+0x1e0>
  800590:	a97ff0ef          	jal	ra,800026 <__panic>
