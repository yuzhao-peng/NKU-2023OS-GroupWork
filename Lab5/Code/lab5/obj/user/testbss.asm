...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5dc50513          	addi	a0,a0,1500 # 800610 <main+0xb2>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	5dc50513          	addi	a0,a0,1500 # 800630 <main+0xd2>
...
exit(int error_code) {
  ...
  80012a:	51250513          	addi	a0,a0,1298 # 800638 <main+0xda>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	6f278793          	addi	a5,a5,1778 # 800870 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d6:	47aa0a13          	addi	s4,s4,1146 # 80064c <main+0xee>
  ...
  8001e2:	5cac0c13          	addi	s8,s8,1482 # 8007a8 <error_string>
  ...
  8002d0:	69460613          	addi	a2,a2,1684 # 800960 <error_string+0x1b8>
  ...
  800464:	4f060613          	addi	a2,a2,1264 # 800950 <error_string+0x1a8>
  ...
  800476:	4d660613          	addi	a2,a2,1238 # 800948 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80047a:	00000417          	auipc	s0,0x0
  80047e:	4cf40413          	addi	s0,s0,1231 # 800949 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  80050a:	44340413          	addi	s0,s0,1091 # 800949 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800564:	40850513          	addi	a0,a0,1032 # 800968 <error_string+0x1c0>
main(void) {
  ...
  80056e:	00001597          	auipc	a1,0x1
  800572:	a9258593          	addi	a1,a1,-1390 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  800576:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  800578:	4681                	li	a3,0
  80057a:	00100637          	lui	a2,0x100
  80057e:	a029                	j	800588 <main+0x2a>
  800580:	2685                	addiw	a3,a3,1
  800582:	0791                	addi	a5,a5,4
  800584:	00c68f63          	beq	a3,a2,8005a2 <main+0x44>
        if (bigarray[i] != 0) {
  800588:	4398                	lw	a4,0(a5)
  80058a:	db7d                	beqz	a4,800580 <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  80058c:	00000617          	auipc	a2,0x0
  800590:	3fc60613          	addi	a2,a2,1020 # 800988 <error_string+0x1e0>
  800594:	45b9                	li	a1,14
  800596:	00000517          	auipc	a0,0x0
  80059a:	41250513          	addi	a0,a0,1042 # 8009a8 <error_string+0x200>
  80059e:	a89ff0ef          	jal	ra,800026 <__panic>
  8005a2:	00001717          	auipc	a4,0x1
  8005a6:	a5e70713          	addi	a4,a4,-1442 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005aa:	4781                	li	a5,0
  8005ac:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  8005b0:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005b2:	2785                	addiw	a5,a5,1
  8005b4:	0711                	addi	a4,a4,4
  8005b6:	fed79de3          	bne	a5,a3,8005b0 <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005ba:	4681                	li	a3,0
  8005bc:	00100737          	lui	a4,0x100
  8005c0:	a029                	j	8005ca <main+0x6c>
  8005c2:	2685                	addiw	a3,a3,1
  8005c4:	0591                	addi	a1,a1,4
  8005c6:	02e68063          	beq	a3,a4,8005e6 <main+0x88>
        if (bigarray[i] != i) {
  8005ca:	419c                	lw	a5,0(a1)
  8005cc:	fed78be3          	beq	a5,a3,8005c2 <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8005d0:	00000617          	auipc	a2,0x0
  8005d4:	3e860613          	addi	a2,a2,1000 # 8009b8 <error_string+0x210>
  8005d8:	45d9                	li	a1,22
  8005da:	00000517          	auipc	a0,0x0
  8005de:	3ce50513          	addi	a0,a0,974 # 8009a8 <error_string+0x200>
  ...
  8005ea:	3fa50513          	addi	a0,a0,1018 # 8009e0 <error_string+0x238>
  8005ee:	ab3ff0ef          	jal	ra,8000a0 <cprintf>
    cprintf("testbss may pass.\n");
  8005f2:	00000517          	auipc	a0,0x0
  8005f6:	42650513          	addi	a0,a0,1062 # 800a18 <error_string+0x270>
  8005fa:	aa7ff0ef          	jal	ra,8000a0 <cprintf>
  ...
  8005fe:	4501                	li	a0,0
    bigarray[ARRAYSIZE + 1024] = 0;
  800600:	00402797          	auipc	a5,0x402
  800604:	a007a023          	sw	zero,-1536(a5) # c02000 <bigarray+0x401000>
    exit(0);
  800608:	b17ff0ef          	jal	ra,80011e <exit>
